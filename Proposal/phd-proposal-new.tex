...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Response Threshold Model for MAS Collaboration}\label{sec:expsetup}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Macroscopic analysis}\label{sec:macromodel}
...
\subsubsection{A general model of probabilistic task allocation}
...
\subsubsection{From individual choices to team-level collaboration}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Microscopic Model}\label{sec:micromodel}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Existence of an Equilibrium Strategy for Communication-Free Multi-Robot Task-Assignment}
...
\subsection{Concurrent Benefit Task with Imperfect Information}\label{sec:conbenefit}
