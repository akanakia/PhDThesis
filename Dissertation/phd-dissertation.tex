...
\begin{align}\label{eq:ilp}
	\text{Maximize}\hspace{1cm} & \We = \sum\limits_{t \in \Ta} W(t, |A(t)|)\\
...
\begin{figure}[!ht]\label{fig:controlexpresults}
