...
\geometry{papersize={6.14in,9.21in}, top=.75in, bottom=.75in, left=0.75in, right=0.75in}
...
% Packages for footnotes and text blocks
...
\begin{figure}[!tb]
\centering\includegraphics[width=\textwidth]{../assets/martinoliModelMethod.png}
...
\chaptermark{Optimal Control Design}
...
\chaptermark{Existence of Equilibrium Strategy}
...
\chaptermark{Response Threshold Model}
...
\chaptermark{Centralized vs.~Hybrid Approaches} 
